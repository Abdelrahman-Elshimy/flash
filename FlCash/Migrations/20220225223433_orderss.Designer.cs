...
namespace FlCash.Migrations
{
    ...
    [Migration("20220225223433_orderss")]
            ...
            modelBuilder.Entity("FlCash.Data.ModeDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2022, 3, 5, 0, 34, 32, 209, DateTimeKind.Local).AddTicks(3277),
                            ModeId = 2L,
                            Start = new DateTime(2022, 2, 26, 0, 34, 32, 207, DateTimeKind.Local).AddTicks(5307)
                        });
                });
