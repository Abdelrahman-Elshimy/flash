...
namespace FlCash.Migrations
{
    ...
    [Migration("20220224110358_Trivisa")]
    partial class Trivisa
    {
            ...
            modelBuilder.Entity("FlCash.Data.ModeDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2022, 3, 3, 13, 3, 57, 354, DateTimeKind.Local).AddTicks(9607),
                            ModeId = 2L,
                            Start = new DateTime(2022, 2, 24, 13, 3, 57, 353, DateTimeKind.Local).AddTicks(7533)
                        });
                });
