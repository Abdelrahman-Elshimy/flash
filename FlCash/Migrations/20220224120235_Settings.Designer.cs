...
namespace FlCash.Migrations
{
    ...
    [Migration("20220224120235_Settings")]
            ...
            modelBuilder.Entity("FlCash.Data.ModeDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2022, 3, 3, 14, 2, 34, 247, DateTimeKind.Local).AddTicks(7830),
                            ModeId = 2L,
                            Start = new DateTime(2022, 2, 24, 14, 2, 34, 246, DateTimeKind.Local).AddTicks(892)
                        });
                });
