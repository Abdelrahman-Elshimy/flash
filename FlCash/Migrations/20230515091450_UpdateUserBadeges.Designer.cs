...
namespace FlCash.Migrations
{
    ...
    [Migration("20230515091450_UpdateUserBadeges")]
    partial class UpdateUserBadeges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlCash.Data.ApiUser", b =>
                {
                    ...
                    b.Property<int>("AddsCounter")
                        .HasColumnType("int");

                    b.Property<int>("ArtQuestionCount")
                        .HasColumnType("int");

                    b.Property<int>("BuysFromStoreCounter")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CounterDailyGift")
                        .HasColumnType("int");

                    b.Property<int>("EasyLevelQuestionCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EntertainmanetQuestionCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("GeoQuestionCount")
                        .HasColumnType("int");

                    b.Property<string>("Governement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("HardLevelQuestionCount")
                        .HasColumnType("int");

                    b.Property<int>("Hearts")
                        .HasColumnType("int");

                    b.Property<int>("HistoryQuestionCount")
                        .HasColumnType("int");

                    b.Property<string>("Image")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("InvitationCounter")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MediumLevelQuestionCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PlayedGamesCounter")
                        .HasColumnType("int");

                    b.Property<int>("Points")
                        .HasColumnType("int");

                    b.Property<int>("PointsInMonth")
                        .HasColumnType("int");

                    b.Property<int>("PointsInWeek")
                        .HasColumnType("int");

                    b.Property<int>("RightCounterCounter")
                        .HasColumnType("int");

                    b.Property<int>("ScienceQuestionCount")
                        .HasColumnType("int");

                    b.Property<string>("SecurityStamp")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SendGiftsCounter")
                        .HasColumnType("int");

                    b.Property<int>("SportsQuestionCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UploadedQuestion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlCash.Data.Badge", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FlCash.Data.DailyGift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlCash.Data.HwaratTrivia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("hwaratTrivias");
                });

            modelBuilder.Entity("FlCash.Data.HwaratTriviaMissionUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CountOfQuestionsSolved")
                        .HasColumnType("int");
                    ...
                    b.ToTable("HwaratTriviaMissionUsers");
                });
            ...
            modelBuilder.Entity("FlCash.Data.Mission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlCash.Data.ModeDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2023, 5, 22, 12, 14, 49, 833, DateTimeKind.Local).AddTicks(6795),
                            ModeId = 2L,
                            Start = new DateTime(2023, 5, 15, 12, 14, 49, 829, DateTimeKind.Local).AddTicks(4134)
                        });
                });
            ...
            modelBuilder.Entity("FlCash.Data.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlCash.Data.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("StoreServicePlanId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlCash.Data.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlCash.Data.UserTriviaGifted", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("TriviaGiftId");

                    b.HasIndex("UserId");

                    b.ToTable("UserTriviaGifteds");
                });
            ...
            modelBuilder.Entity("FlCash.Data.HwaratTriviaMissionUser", b =>
                {
                    b.HasOne("FlCash.Data.Mission", "Mission")
                        .WithMany()
            ...
            modelBuilder.Entity("FlCash.Data.Order", b =>
                {
                    b.HasOne("FlCash.Data.StoreServicePlan", "StoreServicePlan")
                        .WithMany()
                        .HasForeignKey("StoreServicePlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FlCash.Data.UserTriviaGifted", b =>
                {
                    b.HasOne("FlCash.Data.TriviaGift", "TriviaGift")
                        .WithMany()
                        .HasForeignKey("TriviaGiftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
