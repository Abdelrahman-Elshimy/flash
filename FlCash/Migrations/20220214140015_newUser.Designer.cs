...
namespace FlCash.Migrations
{
    ...
    [Migration("20220214140015_newUser")]
            ...
            modelBuilder.Entity("FlCash.Data.ModeDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2022, 2, 21, 16, 0, 14, 470, DateTimeKind.Local).AddTicks(7351),
                            ModeId = 2L,
                            Start = new DateTime(2022, 2, 14, 16, 0, 14, 469, DateTimeKind.Local).AddTicks(2821)
                        });
                });
