...
namespace FlCash.Migrations
{
    ...
    [Migration("20220223183332_Trivia")]
            ...
            modelBuilder.Entity("FlCash.Data.ModeDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2022, 3, 2, 20, 33, 28, 331, DateTimeKind.Local).AddTicks(3024),
                            ModeId = 2L,
                            Start = new DateTime(2022, 2, 23, 20, 33, 28, 325, DateTimeKind.Local).AddTicks(480)
                        });
                });
