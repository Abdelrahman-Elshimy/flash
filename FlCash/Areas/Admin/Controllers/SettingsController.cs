...
namespace FlCash.Areas.Admin.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Privacy,Terms,AboutUs")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Privacy,Terms,AboutUs")] Setting setting)
        {
            if (id != setting.Id)
            {
                return NotFound();
